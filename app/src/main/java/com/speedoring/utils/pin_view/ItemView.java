package com.speedoring.utils.pin_view;
...
public class ItemView extends FrameLayout {
    ...
    private void generateViews(TypedArray styles) {
        ...
        int boxBackgroundColor = styles.getResourceId(R.styleable.OtpTextView_otp_box_background
                , ResourcesCompat.getColor(context.getResources(), R.color.transparent_b, null));
        ...
        if (barEnabled) {
            LayoutParams barViewParams = new LayoutParams(LayoutParams.MATCH_PARENT, (int) barHeight);
