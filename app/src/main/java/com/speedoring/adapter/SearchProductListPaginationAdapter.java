    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                String contact = productListings.get(position).getCendorMobileNumber();
                if (!productListings.get(position).getCendorMobileNumber().isEmpty()) {
                    contact = productListings.get(position).getCendorMobileNumber();
                } else if (!productListings.get(position).getVendorMobileOne().isEmpty()) {
                    contact = productListings.get(position).getCendorMobileNumber();
                } else if (!productListings.get(position).getVendorMobileTwo().isEmpty()) {
                    contact = productListings.get(position).getCendorMobileNumber();
                } else if (!productListings.get(position).getVendorLandlineOne().isEmpty()) {
                    contact = productListings.get(position).getCendorMobileNumber();
                } else if (!productListings.get(position).getVendorLandlineTwo().isEmpty()) {
                    contact = productListings.get(position).getCendorMobileNumber();
                }

                viewHolder.txtProductDes.setText(contact);
