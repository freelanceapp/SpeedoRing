...
public class SearchProductListing implements Parcelable {
    ...
    public final static Parcelable.Creator<SearchProductListing> CREATOR = new Creator<SearchProductListing>() {


        @SuppressWarnings({
                "unchecked"
        })
        public SearchProductListing createFromParcel(Parcel in) {
            return new SearchProductListing(in);
        }

        public SearchProductListing[] newArray(int size) {
            return (new SearchProductListing[size]);
        }

    };

    protected SearchProductListing(Parcel in) {
